...
quesdemo %>%
  ...
  ggplot() +
  geom_point(mapping = aes(x = zing_mean, y = weight_mean), alpha = 0.5) +
  labs(x = "% important/very important responses",
       y = "Mean numeric rating (ω = 0.5)")
ggsave("figures/importance_vs_double_weight.png", height = 3, width = 5)
```
